...
public class Trafficfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView listView=(ListView)rootView.findViewById(R.id.list_traf);

        String[] values = getResources().getStringArray(R.array.traffic_points);
        ...
        ListView listView1=(ListView)rootView.findViewById(R.id.list_car);

        String[] values1 = getResources().getStringArray(R.array.car_points);
